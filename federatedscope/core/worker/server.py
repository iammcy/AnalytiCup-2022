...
class Server(Worker):
    ...
    def __init__(self,
        ...
        ###########################################
        # a dict to save multi-task model params
        ...
        if self.check_buffer(self.state, min_received_num, check_eval_result):
            if not check_eval_result:  # in the training process
                ...
                for model_idx in range(self.model_num):
                    ...
                    # save multi-task aggregated model
                    # self.model_params = result
    ...
    def broadcast_model_para(self,
        ...
        if self.model_num > 1:
            ...
            #         print("broadcast init global model")
            #         model_para = self.model.state_dict()
            #     else:
            #         print("broadcast multi-task aggregated model")
            #         model_para = self.model_params
